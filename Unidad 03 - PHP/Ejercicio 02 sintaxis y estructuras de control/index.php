<?php
  const CATEGORIES = array('profesor', 'estudiante' , 'padre');
  const MOD_TEACHER = array('Asignaturas','Registros de notas' ,'Reuniones' , 'Tutorias') ;
  const MOD_STUDENTS = array('Asignaturas cursadas', 'Registro de Notas');
        ...
        <div class="col s7">
          ...
          <form class="" action="index.html" method="post">
            <div class="input-field col s12">
               <select>
                 <?php foreach (MOD_TEACHER as $key => $value) { ?>
      ...
      <div class="row mod-container">
        <div class="col s7">
          ...
          <form class="" action="index.html" method="post">
            <div class="input-field col s12">
               <select>
                 <?php foreach (MOD_STUDENTS as $key => $value) { ?>
                   <option value="<?php echo $value ?>"><?php echo $value ?></option>
                 <?php } ?>
               </select>
               <label class="teal-text">Módulo</label>
