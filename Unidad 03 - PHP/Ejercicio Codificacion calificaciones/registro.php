<?php
  ...
  $usuario_acceso = $profesor;

    echo "<script>console.log('Debug Objects: " . $usuario_acceso->getName() . "' );</script>";
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col s12">
          <h5>¡Hola <?php echo $usuario_acceso->getName() ?>!</h5>
